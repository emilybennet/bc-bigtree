...
<div class="content header-band-bump">
    ...
    <div class="wrap content-page">
        ...
        <section class="the-meat">
            ...
            <p>Unlock your standard 3-Day badge to BronyCon by entering your pre-paid code below. After submitting your code you'll be taken to Eventbrite, our online registration system, to complete the checkout process.</p>

            <form method="GET" action="https://bronycon2017.eventbrite.com#tickets" class="code-redeem">

                <ul class="unstyled">
                    <li class="form-element">
                      <input type="text" name="discount" id="discount" placeholder="APRIL_XXXXX" required/>
                    </li>
                </ul>
