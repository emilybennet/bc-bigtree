  ...
  <div class="content-page wide-load">
    ...
    <section class="merchant-types">
      ...
      <section>
        <header>
          <h3>Vendor Hall</h3>
          <!--<a href="#closed-for-2017" class="btn btn-fill-white btn-md" target="_blank">Apply to Vendor Hall</a>-->
          <span class="btn btn-white btn-disabled btn-md">Application Closed</span>
          <a href="/about/policies/exhibitor-policies/" class="policy-link">Vendor Hall Policies</a>
        </header>
...
?>
      <section>
        <header>
          ...
          <span class="btn btn-white btn-disabled btn-md">Application Closed</span>
          <div>
              <a href="/about/policies/artist-policies/" class="policy-link" style="display: inline-block">Artist Alley Policies</a>
              <!-- <a href="http://eepurl.com/cgNu89" target="_blank" class="policy-link" style="display: inline-block">Future Wave Notifications</a> -->
               <!-- • <a href="http://bit.ly/BC2017PracticeAristAlley" class="policy-link" style="display: inline-block">Practice Application</a> -->
          </div>
        </header>
        <div class="merchant-specs">
          <p>Slots for individual artists who create and sell their own works of art or perform commissions.</p>
          <p>Single slots: $100 &bull; <strike>Double slots: $175</strike> (sold out).</p>
        </div>
      </section>
      ...
      <section>
        <header>
          <h3>Art Show</h3>
          <span class="btn btn-white btn-disabled btn-md">Application Closed</span>
          <!-- <a href="https://goo.gl/forms/BNPLnZiEt8RB5ewp2" class="btn btn-fill-white btn-md">Apply for Art Show</a> -->
    ...
    <header class="section-heading" id="vendor-booth-types">
      ...
      <section class="badge-types-table hidden-xs">
        ...
        <ul class="perks unstyled">
          ...
          <li>
            <section class="key">
              <span class="name">Basic Electricty</span>
            </section>

            <section class="badge glyphicon-font" data-badge-type="basic-booth">
              <span class="highlight">
                <span class="check desc-text">Included</span>
              </span>
            </section>
