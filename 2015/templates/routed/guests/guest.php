...
<div class="wrap content-page">
  <section class="the-meat">
    ...
    <header class="page-header">
      <h2><?=$guest['name']?></h2>
      <a href="<?=$page['link']?>" class="breadcrumb">&larr; More BronyCon 2015 Guests</a>
    </header>
        ...
        <div>
          ...
          <? 
            ...
            <? if ($guest['vending_vip']): ?>
              <span class="alert info"><?=$guestNameChunks[0]?> doesn't have set autograph hours, but you can find <?=($guestNameChunks[0] == "Agnes") ? 'her' : 'him';?> at the Comic Team booth in the Marketplace!</span>
            <? endif; ?>     
        </div>
      </div>
      <div class="events">
        <div>
          <h3>See <?=$guestNameChunks[0];?> In</h3>
          <? 
