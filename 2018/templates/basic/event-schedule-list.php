...
<div class="content header-band-bump">
  ...
  <div id="events-schedule" class="wrap content-page events-schedule <?=(count($pageNav)>1)?'has-nav':'';?>">
    ...
    <section class="the-meat">
      ...
      <section class="convention-hours" style="margin-bottom:40px;">
        <div class="reg-hours">
          <div>
            ...
            <ul>
              <li><span class="day-block" style="width:160px;">Thursday, July 26</span> 3&ndash;10pm <small>(pre-reg only)</small></li>
              <li><span class="day-block" style="width:160px;">Friday, July 27</span> 8am&ndash;8pm</li>
              <li><span class="day-block" style="width:160px;">Saturday, July 28</span> 8am&ndash;8pm</li>
              <li><span class="day-block" style="width:160px;">Sunday, July 29</span> 9am&ndash;1pm</li>
            </ul>
          </div>
        </div>
        <div class="marketplace-hours">
          <div>
            ...
            <ul>
              <li><span class="day-block" style="width:160px;">Friday, July 27</span> 10am&ndash;6pm</li>
              <li><span class="day-block" style="width:160px;">Saturday, July 28</span> 10am&ndash;6pm</li>
              <li><span class="day-block" style="width:160px;">Sunday, July 29</span> 10am&ndash;4pm</li>
            </ul>
            <small>
              <em>First 30 minutes of entry limited to sponsors each day.</em>
            </small>
          </div>
        </div>
      </section>
      ...
      <? if ($day == "friday") {
        $dTitle = "Friday, July 27";
      } elseif ($day == "saturday") {
        $dTitle = "Saturday, July 28";
      } else {
        $dTitle = "Sunday, July 29";
      }
