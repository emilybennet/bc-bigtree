...
<div class="content header-band-bump">
  ...
  <div class="content-page wide-load">
    ...
    <section class="merchant-types">
      ...
      <section>
        <header>
          ...
          <a href="https://goo.gl/forms/WcFM4vn1KPJ1COGY2" class="btn btn-fill-white btn-md">Hall Cosplay Contest Pre-Registration</a>
          <!-- <span class="btn btn-white btn-disabled btn-md">Application Opens Soon</span> -->
          <a href="hall-cosplay-contest-rules" class="policy-link">Hall Cosplay Contest Rules</a>
        </header>
      ...
      <section>
        <header>
          ...
          <a href="https://goo.gl/forms/iopNgJ9HAYko6woa2" class="btn btn-fill-white btn-md">Fashion Show Pre-Registration</a>
          <!-- <span class="btn btn-white btn-disabled btn-md">Application Opens Soon</span> -->
          <a href="cosplay-fashion-show-rules" class="policy-link">Cosplay Fashion Show Rules</a>
        </header>
        <div class="merchant-specs">
    ...
    <section style="text-align:left;padding-bottom:30px;">
        ...
        <p>A: We are always looking for new ways to improve cosplay events at BronyCon. Over the last few years, with the large growth in attendance and interest in our cosplay-related events, we felt it was time to break it down into two separate events: One for competition and one for fun. </p>
        ...
        <p>A: Yes. But group entries will be limited to 6 entrants. We are on a scheduled time block and must stay on schedule. And you must enter at the level of the highest ranked member. (Novice, Journeyman, or Masters)</p>
