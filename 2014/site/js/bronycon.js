  ...
  if ($("#events-schedule").length) {
    $(".time-block li").each(function(){
      ...
      $(this).qtip({
          ...
          style: {
            classes: 'qtip-light qtip-schedule'
          },
          position: {
              my: 'bottom left',
              at: 'top left',
  ...
  if ($('#vendor-hall-map').length) {
    ...
    $.getScript("/js/vendor-layout.js", function() {
      ...
      $(".map-vendor-booth").hover(function(){
        bn = $(this).data('booth');
        $(".map-vendor-booth-shape[data-booth-shape='"+bn+"']").attr("class","map-vendor-booth-shape active");
      }, function(){
        bn = $(this).data('booth');
        $(".map-vendor-booth-shape[data-booth-shape='"+bn+"']").attr("class","map-vendor-booth-shape");
      });
