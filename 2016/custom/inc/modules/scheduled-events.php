<?
    ...
    public function __construct($debug = false) {
      ...
      $this->friday = strtotime("2016-07-08 00:00:00");
    ...
    */
    ...
    public function getScheduleForConBook2016() {
      $q = sqlquery("SELECT `ev`.`event_name`, `ev`.`description`, `ev`.`start_time`, `ev`.`end_time`, `el`.`location_name`, `ev`.`mature`, `ev`.`fee`, `ev`.`space_limited`, `ev`.`gb_tracks`
