  ...
  <div class="wrap content-page wide-load">
    ...
    <section class="the-meat registration">
      ...
      <section class="badge-pickup-hours sale-banner">
        ...
        <ul>
          <li><span class="day-block" style="width:160px;">Thursday, July 7th</span> 2&ndash;10pm <small>(pre-registered only)</small></li>
      ...
      <div>
          <p style="text-align:center;font-size:80%">
              While pre-registration has closed, 3-Day and single day badges can still be bought at the door. <a href="pre" style="display:block;">Still need to reference pre-registration information?</a>
          </p>
      </div>
